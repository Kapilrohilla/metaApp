...
const HistoryDealSlice = createSlice({
  initialState: [],
  name: 'history',
  reducers: {
    populateDealHistory: function (state, action) {
    ...
    ticketDealSort: function (state, action) {
    ...
    typeDealSort: function (state, action) {
      const sortedData = state.sort((a, b) => {
        const type1 = a?.type;
        const type2 = b?.type;
    ...
    volumeDealSort: function (state, action) {
      const sortedData = state.sort((a, b) => {
    ...
    openTimeDealSort: function (state, action) {
      const sortedData = state.sort((a, b) => {
    ...
    closeTimeDealSort: function (state, action) {
      const sortedData = state.sort((a, b) => {
    ...
    profitDealSort: function (state, action) {
      const sortedData = state.sort((a, b) => {
...
export const {
  ...
  closeTimeDealSort,
  profitDealSort,
} = HistoryDealSlice.actions;

export default HistoryDealSlice;
